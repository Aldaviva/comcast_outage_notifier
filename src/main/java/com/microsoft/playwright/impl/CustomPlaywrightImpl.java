...
/**
 * Like {@link com.microsoft.playwright.impl.PlaywrightImpl PlaywrightImpl}, but it allows you to specify which browser 
 * you want to install, instead of all of them, and it lets you pass custom environment variables before Playwright 
...
public class CustomPlaywrightImpl implements Playwright {
	...
	public static CustomPlaywrightImpl create(final Collection<String> browsersToInstall, final Map<String, String> extraEnvironmentVariables) {
		try {
			...
			final PlaywrightImpl wrapped = connection.initializePlaywright();
